<%@ Page Title="" Language="C#" MasterPageFile="~/CovaiSoft.master" AutoEventWireup="true" CodeFile="FandBLedger.aspx.cs" Inherits="FandBLedger" %>
            ...
            <div style="width: 98%" align="center">
                ...
                <table>
                    <tr>
                         <td colspan="2">    
                            ...
                            <telerik:RadComboBox ID="cmbResident" runat="server" ForeColor="DarkBlue" AllowCustomText="true"
                                Font-Names="Arial" Font-Size="Small" AutoPostBack="true" CssClass="form-controlForResidentAdd"
                         ...
                         &nbsp;&nbsp;
                            ...
                            <telerik:RadDatePicker ID="dtpfordate" runat="server" Culture="English (United Kingdom)" Font-Names="Verdana" Font-Size="Small"
                                Width="160px" CssClass="form-controlForResidentAdd" ReadOnly="true" ToolTip="Select the date from which you wish to view the transaction details." AutoPostBack="true">
                       ...
                       <%-- </td>
                        <td>--%>
                            ...
                            <telerik:RadDatePicker ID="dtpuntildate" runat="server" Culture="English (United Kingdom)" Font-Names="Verdana" Font-Size="Small"
                                Width="160px" CssClass="form-controlForResidentAdd" ReadOnly="true" ToolTip="Select the date till which you wish to view the transaction details." AutoPostBack="true">
                                <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" ViewSelectorText="x"
                                    CssClass="TextBox" Font-Names="Calibri">
                                </Calendar>
                                <DatePopupButton></DatePopupButton>
                    ...
                    <tr style="width:80%">
                        ...
                        <td align="left">
                             <asp:Label ID="Label1" runat="server" Text="Filter By Session : " ForeColor="Maroon" Font-Names="Verdana" Font-Size="Smaller"  Font-Bold="true"></asp:Label>
                             <asp:DropDownList ID="drpSessionfilters" CssClass="form-controlForResidentAdd" ToolTip="."  runat="server" ForeColor="Maroon" Font-Bold="true" OnSelectedIndexChanged="drpSessionfilters_SelectedIndexChanged"  AutoPostBack="true">                                
                            </asp:DropDownList>                           
                        </td>
                    </tr>
                </table>
                                ...
                                <MasterTableView AllowCustomPaging="false">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn HeaderText="Txn.Cd" HeaderStyle-Width="40px" DataField="Group" ReadOnly="true" AllowFiltering="true" FilterControlWidth="35px" HeaderTooltip="This links to the transaction posting rules." ></telerik:GridBoundColumn>
                                          ...
                                          <telerik:GridBoundColumn HeaderText="Name" HeaderStyle-Width="120px" DataField="Name" ReadOnly="true" AllowFiltering="true" FilterControlWidth="105px" HeaderTooltip="Standard narration as set for the transaction code # additional remarks"></telerik:GridBoundColumn>

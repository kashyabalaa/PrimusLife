<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CovaiSoft.master" CodeFile="DiningConfirmation.aspx.cs" Inherits="DiningConfirmation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="main_cnt">
        <div class="first_cnt" style="background-color: #FDF184; height:500px">
            ...
            <asp:UpdatePanel ID="upnlMain" runat="server">
                    ...
                    <div style="width: 100%">
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                               <telerik:RadWindow ID="rwHelp1" Width="700px" Height="500px" VisibleOnPageLoad="false" runat="server"  Title="Help1" Modal="true">
                                <ContentTemplate>
                                    <table>
                                        <tr>
                                            <td>
                                                <br />
                                                <br />
                                                <asp:Image ID="imgHelp1" runat="server" ImageUrl="~/Images/Slide1.JPG" Width="650px" Height="450px" />  
                                            </td>
                                        </tr>
                                ...
                                <td>
                                    <telerik:RadWindow ID="rwHelp2" Width="700px" Height="500px" VisibleOnPageLoad="false"
                                runat="server"  Title="Help2" Modal="true">
                                <ContentTemplate>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Image ID="imgHelp2" runat="server" ImageUrl="~/Images/Slide2.JPG" Width="650px" Height="450px" />  
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <div style="width: 50%; float: left;">
                            ...
                            <table style="border-collapse: collapse; padding: 20px" cellpadding="10px">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <telerik:RadDatePicker ID="dtpDiners" runat="server" Culture="English (United Kingdom)" Font-Names="Verdana" Font-Size="Small"
                                            Width="175px" CssClass="TextBox" ReadOnly="true" ToolTip="You can confirm only for completed sessions within this billing month." AutoPostBack="true" OnSelectedDateChanged="dtpDiners_SelectedDateChanged">
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlDinersSession" CssClass="ddl" ToolTip="Select the session for which you wish to confirm the diners count." runat="server"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlByDoorNo" ToolTip="Booking and guest count are indicated for each resident." CssClass="ddl" runat="server"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; vertical-align: central">
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label7" runat="Server" Text="Booked :" ForeColor=" Black" Font-Names="Calibri" Font-Size="Medium"></asp:Label>
                                                </td>
                                                <td>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <br />
                                                    <asp:Label ID="Label3" runat="Server" Text="Dined" ForeColor=" Black " Font-Names="Calibri" Font-Size="Medium "></asp:Label>
                                                </td>
                                                <td>
                                                    <br />
                                                    <asp:DropDownList ID="ddlDinerDined" ToolTip="By default, the original booking count is displayed.  Change if needed." CssClass="ddl" runat="server"
                                                ...
                                                <td style="text-align: center; width: 100px">
                                                    ...
                                                    <asp:Label ID="lbldineramount" runat="server" Text="" ForeColor="DarkBlue" Font-Size="Smaller" Font-Bold="false"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label6" runat="Server" Text="Booked :" ForeColor=" Black " Font-Names="Calibri" Font-Size="Medium "></asp:Label>
                                                </td>
                                                <td>
                                    ...
                                    <td>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label4" runat="Server" Text="Dined" ForeColor=" Black " Font-Names="Calibri" Font-Size="Medium "></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlGuestDined" ToolTip="By default, the original booking count is displayed.  Change if needed." CssClass="ddl" runat="server"
                                ...
                                <tr>
                                    <td colspan="3">
                                         <marquee direction="left" runat="server" style=" margin-left: 0px; height: 20px; margin-bottom: 0px;">
                                <strong>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table>
                                                        <tr>
                                                            <td>
                                        <asp:Button ID="btnDiningBooking" runat="Server" CssClass="Button" Text="Booking" Width="140px" ToolTip="Click here to update the actual diner count." ForeColor="White" BackColor="DarkGreen"  OnClick="btnDiningBooking_Click"  />
                                                           </td>
                                                                 </tr>
                                                        <tr>
                                                            <td>
                                        <asp:Button ID="btnOneTouchUpdate" runat="Server" CssClass="Button" Text="One Touch Confirm" Width="140px" ToolTip="Click here to update the actual diner count." ForeColor="White" BackColor="DarkGreen"   OnClick="btnOneTouchUpdate_Click" />
                                                                </td>
                                                            </tr>
                                                        <tr>
                                                            <td>
                                        <asp:Button ID="btnAlacarteBilling" runat="server" BackColor="DarkGreen" ForeColor="White" Width="140px"  Text="A la Carte Billing" ToolTip="Click here to view all Menu Items." CssClass="Button" OnClick="btnAlacarteBilling_Click" />
                                                                </td>
                                                            </tr>
                                                        <tr>
                                                        <td>
                                        <asp:Button ID="btnDailyMenu" runat="server" BackColor="DarkGreen" ForeColor="White" Width="140px"  Text="Menu Card" ToolTip="Click here to view all Menu Items." CssClass="Button" OnClick="btnDailyMenu_Click" />
                                                            </td>
                                                            </tr>
                                                        <tr>
                                                            <td>
                                        <asp:Button ID="btnMenuItems" runat="server" BackColor="DarkGreen" ForeColor="White" Width="140px"  Text="Menu Items" ToolTip="Click here to view all Menu Items." CssClass="Button" OnClick="btnMenuItems_Click" />  
                                                                </td>
                                                            </tr>

                                                         <tr>
                                                            <td>
                                        <asp:Button ID="btnCalendar" runat="server" BackColor="DarkGreen" ForeColor="White" Width="140px"  Text="Calendar" ToolTip="Click here to view calendar for Events/Requests/Calendar." CssClass="Button" OnClick="btnCalendar_Click" />  <br /><br />
                                                                </td>
                                                            </tr>
                                                        <tr>
                                                            <td>
                                                    <asp:Button ID="Help1" runat="server" BackColor="DarkGreen" ForeColor="White"  Width="140px" Text="Help1" ToolTip="" CssClass="Button" OnClick="Help1_Click" />
                                                            </td>
                                                                </tr>
                                                        <tr>
                                                            <td>
                                                    <asp:Button ID="Help2" runat="server" BackColor="DarkGreen" ForeColor="White"  Width="140px" Text="Help2" ToolTip="" CssClass="Button" OnClick="Help2_Click" />
                                                                </td>
                                                            </tr>
                                                        </table>
                ...
                <Triggers>
                    ...
                    <asp:PostBackTrigger ControlID="btnAlacarteBilling" />
                    <asp:PostBackTrigger ControlID="btnDailyMenu" />

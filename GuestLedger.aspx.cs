...
public partial class GuestLedger : System.Web.UI.Page
{
    ...
    protected void LoadOtherDet()
    {
        ...
        try
        {
            ...
            if (cmbResident.SelectedValue != "0")
            {
                ...
                {
                    lblLatTxnDt.Text = dsStatement.Tables[1].Rows[0]["LastTxn"].ToString();
                }
                ...
                if (dsStatement.Tables[2].Rows.Count > 0)
                {
                    ...
                    lblTDt.Text = dsStatement.Tables[2].Rows[0]["DR"].ToString();
                }
                else
                {
                    lblTDt.Text = "0.00";
    ...
    private void LoadTitle()
    {
        try
        {
            DataSet dsTitle = sqlobj.ExecuteSP("SP_GetTitleMenus", new SqlParameter() { ParameterName = "@MenuId", SqlDbType = SqlDbType.Int, Value = 164 });
    ...
    protected void LoadGrid1()
    {
        try
        {
            ...
            if (chkstatus.Checked == true)
            {
                ...
                if (cmbResident.SelectedValue == "0")
                {
                    dsStatement = sqlobj.ExecuteSP("CC_GetGuestUnbilledTransactions",
            ...
            else
            {
                ...
                ReportListAll.DataSource = string.Empty;
                ReportListAll.DataBind();
                ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "alert", "alert('No record for your selected Guest.');", true);
            }
    ...
    protected void chkstatus_CheckedChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ReportList.DataSource = string.Empty;
            ReportList.DataBind();
            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "alert", "alert('No record found.');", true);
        }

<%@ Page Title="" Language="C#" MasterPageFile="~/CovaiSoft.master" AutoEventWireup="true" CodeFile="PPlucsChart.aspx.cs" Inherits="PPlucsChart" %>
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 50%; padding-left: 100px">
                    <b>GROUP</b> &nbsp; &nbsp; &nbsp;
        <asp:DropDownList ID="DRPGROUP" AutoPostBack="true" runat="server" ToolTip="PLEASE SELECT GROUP" CssClass="ddlstyle" OnSelectedIndexChanged="DRPGROUP_SelectedIndexChanged"></asp:DropDownList>
                    &nbsp; &nbsp; &nbsp;
        <b>CODE</b> &nbsp; &nbsp; &nbsp;
        <asp:DropDownList ID="DRPCODE" runat="server" ToolTip="PLEASE SELECT CODE" CssClass="ddlstyle"></asp:DropDownList>
                    &nbsp; &nbsp; &nbsp;       

        <asp:Button ID="BTNSEARCH" runat="server" CssClass="btn" Text="SEARCH" ToolTip="PLEASE CLICK HERE TO GET CHART AS PER YOUR SELECTION." OnClick="BTNSEARCH_Click" />
                    <br />
                    <br />
                    <asp:GridView ID="grdview" Visible="false" runat="server" CssClass="Grid"></asp:GridView>
                    <br />
                </td>

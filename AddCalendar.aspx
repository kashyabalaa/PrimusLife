<%@ Page Title="" Language="C#" MasterPageFile="~/CovaiSoft.master" AutoEventWireup="true" CodeFile="AddCalendar.aspx.cs" Inherits="AddCalendar" %>
    ...
    <script type="text/javascript">
        ...
        function AddEvent() {
            ...
            if (event == '' || desc == '') {
                ...
                var x = confirm('Do you want to add this Calendar?');
                if (x) {
                    $.ajax({
                        url: "AddCalendar.aspx/AddEvents",
                        type: "POST",
        ...
        function UpdateEvent() {
            ...
            if (desc == '' || Events == '' || uevents == '' || ueventdesc == '') {
                ...
                if (desc == '20' || desc == '00') {
                    ...
                    salert = 'Do you want to Cancel the calendar?';
                }
                //alert(salert);
                var x = confirm(salert);
                if (x) {
                    $.ajax({
                        url: "AddCalendar.aspx/UpdateEvents",
                        type: "POST",
                        ...
                        success: function (data) {
                            ...
                            //alert(res);
                            if (res == "true") {
                                alert('Calendar details updated successfully');
                                UpdateClear();
                                Refresh();
                            } else {
                                alert('Calendar failed to update');
                            }
                        },
                        error: function (response) {
                            alert(response.responseText);
            ...
            <asp:UpdatePanel ID="upnlMain" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                <ContentTemplate>
                                ...
                                <td>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td align="right">
                                                <asp:Button ID="btnBack" runat="server" CssClass="btn-success" Font-Bold="true" Text="Back" OnClick="btnBack_Click" ForeColor="White" ToolTip="Click here go to Calendar." />
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="width: 100%; vertical-align: middle;" align="left">
                                                <telerik:RadGrid ID="radgvEvents" OnItemDataBound="radgvEvents_ItemDataBound" FilterItemStyle-HorizontalAlign="Left" GroupingSettings-CaseSensitive="false" Width="1100px" Height="400px" Font-Names="Verdana" AllowFilteringByColumn="true" runat="server" Skin="Windows7" OnItemCommand="radgvEvents_ItemCommand" MasterTableView-AutoGenerateColumns="false" AutoGenerateColumns="false" AllowPaging="false" AllowSorting="true">
                                                    <ClientSettings>
                                                    ...
                                                    <MasterTableView>
                                                        ...
                                                        <Columns>
                                                            <telerik:GridTemplateColumn HeaderStyle-Width="50px" AllowFiltering="false" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnradupdate" ToolTip="Click here to edit the calendar." ForeColor="Blue" Text="Edit" runat="server" CommandName="UpdateRow" CommandArgument='<%# Eval("RSN") %>' ></asp:LinkButton>
                                                                </ItemTemplate>
                    ...
                    <div id="dvpopups" runat="server">
                        ...
                        <asp:Panel ID="pnlpopup" runat="server" BackColor="#F2E6E6" Height="520px" Width="750px" Style="display: none">
                                            ...
                                            <td valign="top">
                                                <table style="width: 100%">
                                                    <tr style="background-color: #336699; height: 5%; width: 100%;">
                                                        <td style="color: White; font-weight: normal; font-family: Verdana; font-size: small" align="left">Update Calendar</td>
                                                    </tr>
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <telerik:RadDatePicker ID="lblfromdate" runat="server" Font-Names="Verdana" Font-Size="Small" ToolTip="Calendar date."
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="lblevent" runat="server" Enabled="true" ToolTip="Choose a title/subject for the calendar." MaxLength="80" TextMode="MultiLine" Width="380px" Height="25px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left">
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="lblevedesc" runat="server" ToolTip="Give a brief description of the calendar." MaxLength="2400" TextMode="MultiLine" Width="380px" Height="70px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlupstatus" runat="server" ToolTip="Select the status of calendar." Width="150px">
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                            <asp:CheckBox ID="chkUISSentEmail" runat="server" Text="Inform all residents via email." Font-Names="verdana" ToolTip="When you click here, all the residents with valid Email IDs will be informed about the Calendar via Email."  Visible="false"/>
                                                            <asp:ImageButton ID="imgUwhatapp" ImageUrl="~/Images/wapp2.png" Width="20px" Height="20px" runat="server" OnClick="imgUwhatapp_Click"  Visible="false"/>
                                                            ...
                                                            Make sure you have already connected your Smart Phone (with Whatsapp installed) with the Web.Whatsapp.com portal." Visible="false"></asp:LinkButton>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btnUpdate" ForeColor="White" BackColor="DarkGreen" Font-Bold="true" runat="server" Text="Update" Width="110px" OnClientClick="return UpdateEvent();" OnClick="btnUpdateClear_Click" ToolTip="Click here to update the details of the calendar." />
                                                            <asp:Button ID="btnCancel" ForeColor="White" BackColor="DarkOrange" OnClick="btnCancel_Click" Font-Bold="true" runat="server" Text="Return" Width="110px" ToolTip="Click here to go back to the calendar listing page." />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                        ...
                        <asp:Panel ID="pnlAdd" runat="server" BackColor="#F2E6E6" Height="430px" Width="700px" Style="display: none">
                                    ...
                                    <table style="border: Solid 4px lightbrown; width: 700px; height: 430px; font-family: Verdana; font-size: small;">
                                        <tr>
                                            <td valign="top">
                                                <table style="width: 100%">
                                                    <tr style="background-color: #336699; height: 5%; width: 100%;">
                                                        <td style="color: White; font-weight: normal; font-family: Verdana; font-size: small" align="left">Add Calendar</td>
                                                        <%-- / Notice / Calendar--%>
                                                    </tr>
                                                    <tr style="height: 40px"></tr>
                                                </table>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlEventtype" runat="server" ToolTip="Calendar - General information." Width="120px" Enabled="false">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <telerik:RadDatePicker ID="FromDate" runat="server" ClientEvents-OnDateSelected="OnDateSelected" AutoPostBack="true" Font-Names="Verdana" OnSelectedDateChanged="FromDate_SelectedDateChanged" Font-Size="Small" ToolTip="Calendar date."
                                                                Culture="English (United Kingdom)" Skin="Default" EnableTyping="False" DateInput-CausesValidation="true" ZIndex="99999999">
                                                                <DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtEventName" runat="server" ToolTip="Choose a title/subject for the calendar." MaxLength="80" Width="380px" Height="25px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                            <asp:CheckBox ID="chkIsSentMail" runat="server" Text="Inform all residents via email." Font-Names="verdana" ToolTip="When you click here, all the residents with valid Email IDs will be informed about the Calendar via Email." Visible="false" /><br />
                                                            <asp:ImageButton ID="imgwapp" ImageUrl="~/Images/wapp2.png" Width="20px" Height="20px" runat="server" OnClick="imgwapp_Click" Visible="false"/>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-family: Verdana; font-size: small; font-weight: bold;">
                                                            <asp:Button ID="btnAddEvent" ForeColor="White" BackColor="DarkGreen" Font-Bold="true" ToolTip="Click here to add a new calendar." runat="server" Text="Add" Width="100px" OnClientClick="return AddEvent();" OnClick="btnAddClear_Click" />
                                                            ...
                                                            <%--OnClientClick="Clear();"--%>
                                                            <asp:Button ID="btnAddCancel" ForeColor="White" BackColor="DarkBlue" OnClick="btnAddCancel_Click" Font-Bold="true" runat="server" Text="Return" Width="100px" ToolTip="Click here to go back to the calendar listing page." />

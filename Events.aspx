<%@ Page Title="Events" Language="C#" MasterPageFile="~/CovaiSoft.master" AutoEventWireup="true" CodeFile="Events.aspx.cs" Inherits="Events" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function AddEvent() {
            ...
            var till = $("#<%= RadDatePicker1.ClientID %>").val();
            ...
            if (event == '' || desc == '') {
                ...
                var x = confirm('Do you want to add this Event?  Have you chosen option to inform all via email?');
                if (x) {
                    $.ajax({
                        url: "Events.aspx/AddEvents",
                        type: "POST",
        ...
        function UpdateEvent() {
            ...
            if (desc == '' || Events == '' || uevents == '' || ueventdesc == '') {
                ...
                if (desc == '20' || desc == '00') {
                    ...
                    salert = 'Do you want to Cancel the event?';
                }
                //alert(salert);
                var x = confirm(salert);
                if (x) {
                    $.ajax({
                        url: "Events.aspx/UpdateEvents",
                        type: "POST",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <%--<asp:ToolkitScriptManager ID="toolscrmgr" CombineScripts="true" runat="server" EnableScriptGlobalization="true"></asp:ToolkitScriptManager> --%>
    <div class="main_cnt">
        <div class="first_cnt">
            <asp:UpdatePanel ID="upnlMain" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                <ContentTemplate>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="width: 100%; vertical-align: middle;" align="left">
                                                <telerik:RadGrid ID="radgvEvents" OnItemDataBound="radgvEvents_ItemDataBound" FilterItemStyle-HorizontalAlign="Left" GroupingSettings-CaseSensitive="false" Width="1100px" Height="400px" Font-Names="Verdana" AllowFilteringByColumn="true" runat="server" Skin="Web20" OnItemCommand="radgvEvents_ItemCommand" MasterTableView-AutoGenerateColumns="false" AutoGenerateColumns="false" AllowPaging="false" AllowSorting="true">
                                                    <ClientSettings>
                                                    ...
                                                    <MasterTableView>
                                                        ...
                                                        <Columns>
                                                            <telerik:GridTemplateColumn HeaderStyle-Width="50px" AllowFiltering="false" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbtnradupdate" ToolTip="Click here to edit the event." ForeColor="Blue" Text="Edit" runat="server" CommandName="UpdateRow" CommandArgument='<%# Eval("RSN") %>' Visible='<%# Eval("Status").ToString() == "Scheduled" %>'></asp:LinkButton>
                                                                </ItemTemplate>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="lbtnAdd" Width="120px" Visible="false" OnClick="lbtnAdd_Click" ToolTip="Click here to Add New event." runat="server" Text="Add Event"></asp:LinkButton>

                                                <asp:LinkButton ID="lbtnoncmng" Visible="false" Width="120px" runat="server" ToolTip="Click here to view Oncoming event." Text="OnComing Events" OnClick="lbtnoncmng_Click"></asp:LinkButton>

                                                <asp:LinkButton ID="lbtnAll" Visible="false" Width="120px" runat="server" ToolTip="Click here to view all events." Text="All Events" OnClick="lbtnAll_Click"></asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                    ...
                    <div id="dvpopups" runat="server">
                        ...
                        <asp:Panel ID="pnlpopup" runat="server" BackColor="#ffffe6" Height="520px" Width="750px" Style="display: none">
                                            ...
                                            <td valign="top">
                                                <table style="width: 100%">
                                                    <tr style="background-color: #336699; height: 5%; width: 100%;">
                                                        <td style="color: White; font-weight: normal; font-family: Verdana; font-size: small" align="left">Update Event</td>
                                                    </tr>
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <telerik:RadDatePicker ID="lblfromdate" runat="server" Font-Names="Verdana" Font-Size="Small" ToolTip="Event date."
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="lblevent" runat="server" Enabled="true" ToolTip="Choose a title/subject for the event." MaxLength="80" TextMode="MultiLine" Width="380px" Height="25px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left">
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="lblevedesc" runat="server" ToolTip="Give a brief description of the event." MaxLength="2400" TextMode="MultiLine" Width="380px" Height="70px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlupstatus" runat="server" ToolTip="Select the status of Event." Width="150px">
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                            <asp:CheckBox ID="chkUISSentEmail" runat="server" Text="Inform all residents via email." Font-Names="verdana" ToolTip="When you click here, all the residents with valid Email IDs will be informed about the Event via Email." /><br />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btnUpdate" ForeColor="White" BackColor="DarkGreen" Font-Bold="true" runat="server" Text="Update" Width="110px" OnClientClick="return UpdateEvent();" OnClick="btnUpdateClear_Click" ToolTip="Click here to update the details of the event." />
                                                            <asp:Button ID="btnCancel" ForeColor="White" BackColor="DarkOrange" OnClick="btnCancel_Click" Font-Bold="true" runat="server" Text="Return" Width="110px" ToolTip="Click here to go back to the event listing page." />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                        ...
                        <asp:Panel ID="pnlAdd" runat="server" BackColor="#ffffe6" Height="430px" Width="700px" Style="display: none">
                                    ...
                                    <table style="border: Solid 4px lightbrown; width: 700px; height: 430px; font-family: Verdana; font-size: small;">
                                        <tr>
                                            <td valign="top">
                                                <table style="width: 100%">
                                                    <tr style="background-color: #336699; height: 5%; width: 100%;">
                                                        <td style="color: White; font-weight: normal; font-family: Verdana; font-size: small" align="left">Add a New Event</td>
                                                        <%-- / Notice / Calendar--%>
                                                    </tr>
                                                    <tr style="height: 40px"></tr>
                                                </table>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlEventtype" runat="server" ToolTip="Event - A joyful occassion, a celebration." Width="120px" Enabled="false">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <telerik:RadDatePicker ID="FromDate" runat="server" ClientEvents-OnDateSelected="OnDateSelected" AutoPostBack="true" Font-Names="Verdana" OnSelectedDateChanged="FromDate_SelectedDateChanged" Font-Size="Small" ToolTip="Event date."
                                                                Culture="English (United Kingdom)" Skin="Default" EnableTyping="False" DateInput-CausesValidation="true" ZIndex="99999999">
                                                                <DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtEventName" runat="server" ToolTip="Choose a title/subject for the event.This forms the subject line for the email communication to the residents." MaxLength="80" Width="380px" Height="25px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtdesc" runat="server" ToolTip="Give a brief description of the event.Whatever written here is emailed to all residents." MaxLength="2400" TextMode="MultiLine" Width="380px" Height="70px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-family: Verdana; font-size: small; font-weight: bold;">
                                                            <asp:Button ID="btnAddEvent" ForeColor="White" BackColor="DarkGreen" Font-Bold="true" ToolTip="Click here to add a new event.This will be conveyed to all resident via EMail." runat="server" Text="Add" Width="100px" OnClientClick="return AddEvent();"  OnClick="btnAddClear_Click"/>
                                                            <asp:Button ID="btnAddClear" ForeColor="White" BackColor="DarkOrange" Font-Bold="true" ToolTip="Click here to clear the details you have entered" runat="server" Text="Clear" Width="100px" OnClick="btnAddClear_Click" />
                                                             <%--OnClientClick="Clear();"--%>
                                                            <asp:Button ID="btnAddCancel" ForeColor="White" BackColor="DarkBlue" OnClick="btnAddCancel_Click" Font-Bold="true" runat="server" Text="Return" Width="100px" ToolTip="Click here to go back to the events listing page." />

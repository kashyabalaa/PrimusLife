<%@ Page Title="" Language="C#" MasterPageFile="~/CovaiSoft.master" AutoEventWireup="true" CodeFile="Vacants.aspx.cs" Inherits="Vacants" %>
        ...
        <div class="first_cnt">
            <div>
                <table>
                    <tr>
                        <td>
                             <telerik:RadMenu ID="RMResident" runat="server" Skin="" Width="250px" OnItemClick="RMResident_ItemClick" style="z-index:2900"  >
                              ...
                              <%--<asp:Button ID="btnreturnfromlevelV" runat="server" Text="Return" CssClass="btn btn-info" Visible="true" 
                                                                            OnClick="btnreturnfromlevelV_Click"  ToolTip="Click here to return Resident's." />--%>
                             <asp:Label ID="Label15" Visible="true" Text="Level V - Vacants"
                    ...
                    <tr>
                           <td >
                            <telerik:RadGrid ID="VacantGridView" runat="server" AllowPaging="True" PageSize="20"
                                AutoGenerateColumns="False" Skin="WebBlue" AllowSorting="true" OnItemCommand="VacantGridView_ItemCommand"
                                OnPageIndexChanged="VacantGridView_PageIndexChanged" OnItemDataBound="VacantGridView_ItemDataBound"
                                OnPageSizeChanged="VacantGridView_PageSizeChanged" OnSortCommand="VacantGridView_SortCommand"

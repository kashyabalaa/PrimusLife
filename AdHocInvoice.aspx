<%@ Page Title="" Language="C#" MasterPageFile="~/CovaiSoft.master" AutoEventWireup="true" CodeFile="AdHocInvoice.aspx.cs" Inherits="AdHocInvoice" %>
                                ...
                                <tr>
                                    <td>
                                        <table>
                                            <tr>
                                                <td>
                                                     <asp:Label ID="Label3" runat="server" Text="Maintenance Inv.:" Font-Bold="true" Font-Size="Smaller"></asp:Label>
                                                     <asp:Label ID="lblMain" runat="server" Text="-" ForeColor="Maroon" Font-Bold="true" Font-Size="Smaller"></asp:Label>
                                                </td>
                                            </tr>
                                             <tr>
                                                <td>
                                                     <asp:Label ID="Label2" runat="server" Text="F and B Inv.:" Font-Bold="true" Font-Size="Smaller"></asp:Label>
                                                     <asp:Label ID="lblFandB" runat="server" Text="-" ForeColor="Maroon" Font-Bold="true" Font-Size="Smaller"></asp:Label>
                                                </td>
                                            </tr>
                                             <tr>
                                                <td>
                                                     <asp:Label ID="Label5" runat="server" Text="Cab Inv.:" Font-Bold="true" Font-Size="Smaller"></asp:Label>
                                                     <asp:Label ID="lblCab" runat="server" Text="-" ForeColor="Maroon" Font-Bold="true" Font-Size="Smaller"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>

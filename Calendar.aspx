<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CovaiSoft.master" CodeFile="Calendar.aspx.cs" Inherits="Calendar" %>
    ...
    <link href="Calendar/lib/site.css" rel="stylesheet" />
     ...
     <script type="text/javascript">
        ...
        function LoadCalendar() {
            $.ajax({
                url: '<%= ResolveUrl("Calendar.aspx/CalCalendar") %>',
                type: "POST",
                data: "{}",

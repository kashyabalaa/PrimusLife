<%@ Page Title="" Language="C#" MasterPageFile="~/CovaiSoft.master" AutoEventWireup="true" CodeFile="StaffandOthers.aspx.cs" Inherits="StaffandOthers" %>
        ...
        <div class="first_cnt">
            <div>
                <table >
                    ...
                    <tr>
                        <td >
                            <telerik:RadGrid ID="StaffandOthersView" runat="server" AllowPaging="True" PageSize="20"
                                AutoGenerateColumns="False" Skin="WebBlue" AllowSorting="true" OnItemCommand="StaffandOthersView_ItemCommand"
                                OnPageIndexChanged="StaffandOthersView_PageIndexChanged" OnItemDataBound="StaffandOthersView_ItemDataBound"
                                OnPageSizeChanged="StaffandOthersView_PageSizeChanged" OnSortCommand="StaffandOthersView_SortCommand"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="5px"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="Lnkbtnview" runat="server" Text="View" ToolTip="Click here to View profile" Font-Bold="true" Font-Size="XX-Small" ForeColor="Blue" OnClick="Lnkbtnview_Click">View</asp:LinkButton>
                                        ...
                                        <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="5px"
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="LnkbtnAddOn" runat="server" Text="++" Font-Bold="true" ToolTip="Click to manage additional particulars of the profile" Font-Size="XX-Small" ForeColor="Blue" OnClick="LnkbtnAddOn_Click">++</asp:LinkButton>
                                                <%--<asp:ImageButton ID="ImagBtnnEdit" Height="15px" ToolTip="Click here to Edit resident details" Width="25px" ImageUrl="~/App_Theme/edit-icon1.png" OnClick="ImagBtnnEdit_Click" runat="server" />--%>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="250px" DataField="RTName"

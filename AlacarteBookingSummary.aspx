<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CovaiSoft.master" CodeFile="AlacarteBookingSummary.aspx.cs" Inherits="AlacarteBookingSummary" %>
                        ...
                        <table cellspacing="5" cellpadding="5">
                            ...
                            <tr style="vertical-align:middle;">
                                <td>
                                    ...
                                    From Date : &nbsp;  
                                    <telerik:RadDatePicker ID="radfromdate" Width="130px" runat="server" Font-Names="Verdana" Font-Size="Small" ToolTip="Select the date from which you wish to view the A La Carte Booking Summary"
                                    ...
                                    Till Date : &nbsp;
                                     <telerik:RadDatePicker ID="radtilldate" Width="130px" runat="server" Font-Names="Verdana" Font-Size="Small" ToolTip="Select the date till which you wish to view the A La Carte Booking Summary."
                                        Culture="English (United Kingdom)" Skin="Default" EnableTyping="False" DateInput-CausesValidation="true" ZIndex="99999999">
                                        <DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                                    ...
                                    Session :  <asp:DropDownList ID="ddlSession" ToolTip="Select a session to view the A La Carte Booking Summary on that session." Width="200px" Height="25px" runat="server" AutoPostBack="true"
                            ...
                            <tr>
                                <td>
                                    <telerik:RadGrid ID="gvBookingameal" GroupingSettings-CaseSensitive="false" Skin="WebBlue" AllowSorting="true" runat="server" AutoGenerateColumns="false" OnItemCommand="gvBookingameal_ItemCommand" Width="100%" 
